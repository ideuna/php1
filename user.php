                    ...
                    <div class="login-form">
                        <form action="#">
                            <div class="form-group">
                                ...
                                <input name="id" type="email" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="<?=$_SESSION['id'];?>" disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input name="pwc" type="password" class="form-control" id="exampleInputPassword1"
                            ...
                            <div class="form-group">
                                ...
                                <input name="address" type="text" class="form-control"
                                    value="<?=$_SESSION['address'];?>" disabled>
                            </div>

                            <button type="button" class="btn oneMusic-btn mt-30"
                                onclick="location.href='userChange.php'">정보수정</button>
                            <button type="button" class="btn oneMusic-btn mt-30"
                                onclick="location.href='_signout.php'">회원탈퇴</button>
                        </form>
                    </div>
                </div>
            </div>
