        ...
        <div class="row">
            <div class="col-12 col-lg-9">
                ...
                <div class="single-blog-post mb-15 wow fadeInUp" data-wow-delay="100ms">
                    ...
                    <div class="blog-content">
                        ...
                        <div class="post-meta d-flex mb-30">
                            ...
                            ?>
                            <button class="ml-5 btn btn-secondary"
                                onclick="location.href='bbs1mod.php?no=<?=$bbs['no'];?>'">수정</button>
                            <button class="ml-1 btn btn-secondary"
                                onclick="location.href='_bbs1delete.php?no=<?=$bbs['no'];?>'">삭제</button>
                            <?php 
                ...
                <div class="oneMusic-pagination-area wow fadeInUp" data-wow-delay="300ms">
                    <nav>
                        <ul class="pagination">
                            <li class="page-item active"><a class="page-link" href="bbs.php?current_page=1">⏮️</a></li>
                            <?php
                                if ($current_page > 1) { ?>
                            <li class="page-item active"><a class="page-link"
                                    href="bbs.php?current_page=<?=$prev_page;?>">앞</a></li>
                            <?php } else {  ?>
                            <li class="page-item active"><a class="page-link" href="#">앞</a></li>
                            <?php } ?>
                            <?php if ($current_page < $end_page) { ?>
                            <li class="page-item active"><a class="page-link"
                                    href="bbs.php?current_page=<?=$next_page;?>">뒤</a></li>
                            <?php } else { ?>
                            <li class="page-item active"><a class="page-link" href="#">뒤</a></li>
                            <?php } ?>
                            <li class="page-item active"><a class="page-link"
                                    href="bbs.php?current_page=<?=$end_page;?>">⏭️</a></li>
